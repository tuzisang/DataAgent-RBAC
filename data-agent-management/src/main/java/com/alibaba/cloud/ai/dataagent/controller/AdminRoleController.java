...
public class AdminRoleController {
	...
	public ApiResponse<List<SysPermission>> getPermissions(@PathVariable Long roleId) {
		return ApiResponse.success(roleService.getPermissionsByRoleId(roleId));
	}

	@PutMapping("/{roleId}/permissions")
	public ApiResponse<Void> updatePermissions(@PathVariable Long roleId, @RequestBody List<Long> permissionIds) {
